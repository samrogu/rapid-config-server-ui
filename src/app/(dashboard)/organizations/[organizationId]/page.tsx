...
import { Organization, Application, OrganizationUser } from '@/types/models';
...
const OrganizationDetailsPage = () => {
  ...
  const handleAddApplication = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await axiosInstance.post(`${apiRoutes.applications.base}/organization/${organizationId}`, rest);
  ...
  const handleEditApplicationSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setApplicationFormData(initialApplicationFormData); // Reiniciar el formulario
  ...
  return (
    <div className="bg-gray-900 text-gray-200 p-6 rounded-lg shadow-md">
      ...
      <TabNavigation
        ...
        activeTab={activeTab}
        onTabChange={(value: string) => setActiveTab(value as 'applications' | 'users')}
      />
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-700/50 rounded-lg p-4 text-sm text-gray-300">
              ...
              <ul className="list-disc list-inside mt-2 space-y-1">
                <li>Delete all associated applications</li>
                <li>Remove all organization settings</li>
                <li>Remove all user access</li>
              </ul>
            </div>
