    ...
    <div className="flex min-h-screen bg-gray-100">
      ...
      <aside className="bg-white w-64 hidden lg:block shadow-md">
        <div className="p-6">
          {/* Logo */}
          <Image
            src="/springconfig.png" // Cambia esto por el logo de tu aplicación
            alt="Logo"
            width={120}
            height={40}
            className="mb-8"
          ...
          {/* Navigation */}
          <nav>
            <h2 className="text-sm font-bold text-gray-500 uppercase mb-4">Apps</h2>
            <ul className="space-y-2 font-medium">
              <li>
                <a
                  href="/dashboard"
                  className="flex items-center p-2 text-gray-800 rounded-lg hover:bg-gray-100 hover:text-blue-600 group"
                >
                  <svg
